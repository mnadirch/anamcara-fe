  ...
  if (resetSent) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
        <div className=" revolving-line-border max-w-md w-full relative overflow-hidden">
          <div className=" bg-gray-800 shadow-xl rounded-lg p-8">
            <div className="text-center">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mx-auto text-[#A0FF06] mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
